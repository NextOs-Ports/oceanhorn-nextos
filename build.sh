#!/bin/bash
# Build de desenvolvimento/release no sysroot corrente do NextOS Amlogic-old.
# Outros devices/sistemas exigem uma variante separada e explicitamente pedida.
set -euo pipefail
...
echo "NEXTOS BUILD OK -> $(file oceanhorn | cut -d, -f1-3)"
echo "toolchain: $TC"
